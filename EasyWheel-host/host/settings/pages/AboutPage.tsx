  ...
  return (
    ...
    >
      ...
      >
        {/* Logo Icon */}
        <div
          className="w-20 h-20 rounded-2xl flex items-center justify-center overflow-hidden p-2"
          style={{
        ...
        >
          <img src="/Logo.png" alt="EasyWheel Logo" className="w-full h-full object-contain" />
        </div>
