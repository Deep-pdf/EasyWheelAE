    ...
    <header className="panel-header">
      <div className="header-top">
        <div className="brand">
          ...
          <span className="brand-name">EasyWheel</span>
        </div>
      ...
      <div className="header-meta">
        <div className="meta-left">
          <span className="app-name">Adobe After Effects</span>
        </div>
        <div className="meta-right">
          <span className="meta-label">Profile:</span>
          <span className="meta-value">{profileName}</span>
          <span className={`status-indicator ${getStatusClass(connectionStatus)}`}></span>
        </div>
      </div>
    </header>
  );
